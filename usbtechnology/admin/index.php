...
<body class="bg-gradient-primary">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">BIEVENIDO LOGIN</h1>
    ...
    <script src="../assets/js/sb-admin-2.min.js"></script>
     ...
     <!-- Código de instalación Cliengo para wixo23@hotmail.com --> 
  <script type="text/javascript">(function () { var ldk = document.createElement('script'); ldk.type = 'text/javascript'; ldk.async = true; ldk.src = 'https://s.cliengo.com/weboptimizer/62c863ef030965002a8c3db5/62c863f1030965002a8c3db8.js?platform=view_installation_code'; var s = document.getElementsByTagName('script')[0]; s.parentNode.insertBefore(ldk, s); })();</script>
